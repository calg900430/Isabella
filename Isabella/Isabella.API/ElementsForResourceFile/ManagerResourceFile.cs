namespace Isabella.API.ElementsForResourceFile
{
    using System.IO;
    ...
    /// </summary>
    public static class ManagerResourceFile
    {
        
        /// <summary>
        /// Genera el archivo de recursos.
        /// </summary>
        public static void GenerateResourceFileAsync()
        {
            using (ResourceWriter rw = new ResourceWriter($"{Directory.GetCurrentDirectory()}\\ResourceFile.resources"))
            {
                ...
                rw.AddResource("ProductAllNotFound", "No hay productos disponibles.");
