namespace Isabella.API.ServicesControllers
{
    ...
    public class ProductSpecialServiceController : IProductSpecialRepositoryDto
    {
        ...
        /// <returns></returns>
        public async Task<ServiceResponse<bool>> AddProductSpecialAsync(AddProductStandardSpecialDto addProductSpecial)
        {
            ServiceResponse<bool> serviceResponse = new ServiceResponse<bool>();
            try
            {
                if (addProductSpecial == null)
                {
                ...
                var new_product = new ProductSpecial
                {
                    ...
                    IsAvailabe = addProductSpecial.IsAvailabe,
                    Name = addProductSpecial.Name,
                    Price = addProductSpecial.Price,
                    Stock = addProductSpecial.Stock,
                    LastBuy = DateTime.UtcNow,
                };
                await this._productSpecialRepositoryModel
                .AddProductSpecialAsync(new_product)
                .ConfigureAwait(false);
        ...
        /// <returns></returns>
        public async Task<ServiceResponse<bool>> AddImageProductSpecialAsync(IFormFile formFile, int ProductId)
        {
            ServiceResponse<bool> serviceResponse = new ServiceResponse<bool>();
            try
            {
                ...
                .GetProductSpecialForIdNotIncludeAsync(ProductId)
                .ConfigureAwait(false);
                if (product == null)
                {
                ...
                //Agrega las imagenes
                var add_images = await this._productSpecialRepositoryModel
                .AddImageForProductSpecialAsync(formFile, product)
                .ConfigureAwait(false);
                if (!add_images)
                {
        ...
        /// <returns></returns>
        public async Task<ServiceResponse<bool>> AddImageProductSpecialAsync(AddImageProductSpecialDto addImageProductSpecial)
        {
            ServiceResponse<bool> serviceResponse = new ServiceResponse<bool>();
            try
            {
                //Verifica que la imagen, cumpla con los reguerimientos para poderla almacenar en la base de datos.
                if (addImageProductSpecial == null)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeError_NullObjectSend;
                    serviceResponse.Data = false;
                    serviceResponse.Success = false;
                ...
                //Verifica que la imagen, cumpla con los reguerimientos para poderla almacenar en la base de datos.
                if (addImageProductSpecial.Image == null)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeError_NullObjectSend;
                    serviceResponse.Data = false;
                    serviceResponse.Success = false;
                ...
                if (addImageProductSpecial.Image.Length <= 0)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeError_NullObjectSend;
                    serviceResponse.Data = false;
                    serviceResponse.Success = false;
                ...
                if (addImageProductSpecial.Image.Length > Constants.MAX_LENTHG_IMAGE_PRODUCT)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeImage_ImageUserNotValide;
                    serviceResponse.Data = false;
                    serviceResponse.Success = false;
                ...
                //Obtiene el producto.
                var product = await this._productSpecialRepositoryModel
                .GetProductSpecialForIdNotIncludeAsync(addImageProductSpecial.ProductId)
                .ConfigureAwait(false);
                if (product == null)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeProduct_NotFound;
                ...
                //Agrega las imagenes
                var add_images = await this._productSpecialRepositoryModel
                .AddImageForProductSpecialAsync(addImageProductSpecial.Image, product)
                .ConfigureAwait(false);
                if (!add_images)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeImage_ImageErrorCreated;
        ...
        public async Task<ServiceResponse<bool>> DeleteImageProductSpecialAsync(int ProductId, int ImageId)
        {
            ServiceResponse<bool> serviceResponse = new ServiceResponse<bool>();
            try
            {
                ...
                var image_product_standard = await this._productSpecialRepositoryModel
                .GetImageProductSpecialAsync(product, ImageId)
                .ConfigureAwait(false);
                ...
                await this._productSpecialRepositoryModel
                .DeleteImageProductSpecialAsync(image_product_standard).ConfigureAwait(false);
                serviceResponse.Code = CodeMessage.Code.CodeSuccess_Ok;
                serviceResponse.Data = true;
                serviceResponse.Success = true;
                serviceResponse.Message = CodeMessage.MessageOfCode(CodeMessage.Code.CodeSuccess_Ok);
        ...
        /// <param name="ProductId"></param>
        /// <returns></returns>
        public async Task<ServiceResponse<bool>> DisableProductSpecialAsync(int ProductId)
        {
            ServiceResponse<bool> serviceResponse = new ServiceResponse<bool>();
            try
            {
                ...
                var enable_product = await this._productSpecialRepositoryModel
                .UpdateProductSpecialAsync(product)
                .ConfigureAwait(false);
        ...
        /// <param name="ProductId"></param>
        /// <returns></returns>
        public async Task<ServiceResponse<bool>> EnableProductSpecialAsync(int ProductId)
        {
            ServiceResponse<bool> serviceResponse = new ServiceResponse<bool>();
            try
            {
        ...
        /// <param name="ProductId"></param>
        /// <returns></returns>
        public async Task<ServiceResponse<List<GetImageProductSpecialDto>>> GetAllImageProductSpecialAsync(int ProductId)
        {
            ServiceResponse<List<GetImageProductSpecialDto>> serviceResponse = new ServiceResponse<List<GetImageProductSpecialDto>>();
            try
            {
                //Obtiene el producto.
                var product = await this._productSpecialRepositoryModel
                ...
                var all_images = await this._productSpecialRepositoryModel
                .GetAllImageProductSpecialAsync(product)
                .ConfigureAwait(false);
                if (all_images == null)
                {
                ...
                serviceResponse.Code = CodeMessage.Code.CodeSuccess_Ok;
                serviceResponse.Data = all_images.Select(c => new GetImageProductSpecialDto
                {
                    Image = c.Image,
                    ImageId = c.Id,
                    ProductId = c.ProductSpecial.Id
                }).ToList();
                serviceResponse.Success = true;
                serviceResponse.Message = CodeMessage.MessageOfCode(CodeMessage.Code.CodeSuccess_Ok);
                return serviceResponse;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ServiceResponse<List<GetProductSpecialDto>>> GetAllProductSpecialAsync()
        {
            ServiceResponse<List<GetProductSpecialDto>> serviceResponse = new ServiceResponse<List<GetProductSpecialDto>>();
            try
            {
                //Obtiene los productos disponibles
                var all_productstandard = await this._productSpecialRepositoryModel
                .GetAllProductSpecialWithCategoryAsync()
                .ConfigureAwait(false);
        ...
        /// <returns></returns>
        public async Task<ServiceResponse<List<GetImageProductSpecialDto>>> GetCantImageProductSpecialAsync(int ProductId, int ImageId, int CantImages)
        {
            ServiceResponse<List<GetImageProductSpecialDto>> serviceResponse = new ServiceResponse<List<GetImageProductSpecialDto>>();
            try
            {
                ...
                var all_images_product = await this._productSpecialRepositoryModel
                .GetAllImageProductSpecialAsync(product)
                .ConfigureAwait(false);
                ...
                if (CantImages >= image_available)
                {
                    ...
                    serviceResponse.Data = list_images_to_send.Select(c => new GetImageProductSpecialDto
                    {
                        Image = c.Image,
                        ImageId = c.Id,
        ...
        /// <returns></returns>
        public async Task<ServiceResponse<List<GetProductSpecialDto>>> GetCantProductSpecialAsync(int ProductId, int CantProduct)
        {
            ServiceResponse<List<GetProductSpecialDto>> serviceResponse = new ServiceResponse<List<GetProductSpecialDto>>();
            try
            {
                ...
                var all_productsstandard = await this._productSpecialRepositoryModel
                .GetAllProductSpecialWithCategoryAsync()
                .ConfigureAwait(false);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ServiceResponse<int>> GetIdOfLastProductSpecialAsync()
        {
            ServiceResponse<int> serviceResponse = new ServiceResponse<int>();
            try
            {
                var last_id_product = await this._productSpecialRepositoryModel
        ...
        /// <param name="ImageId"></param>
        /// <returns></returns>
        public async Task<ServiceResponse<GetImageProductSpecialDto>> GetImageProductSpecialForIdAsync(int ProductId, int ImageId)
        {
            ServiceResponse<GetImageProductSpecialDto> serviceResponse = new ServiceResponse<GetImageProductSpecialDto>();
            try
            {
                //Obtiene el producto.
                var product = await this._productSpecialRepositoryModel
                ...
                //Verifica si el producto tiene la imagen especifica.
                var image_product = await this._productSpecialRepositoryModel
                .GetImageProductSpecialAsync(product, ImageId)
                .ConfigureAwait(false);
                ...
                //Elimina la imagen especifica.
                serviceResponse.Code = CodeMessage.Code.CodeSuccess_Ok;
                serviceResponse.Data = new GetImageProductSpecialDto
                {
                    Image = image_product.Image,
                    ProductId = image_product.ProductSpecial.Id,
        ...
        /// <param name="ProductId"></param>
        /// <returns></returns>
        public async Task<ServiceResponse<List<int>>> GetListIdOfImageProductSpecialAsync(int ProductId)
        {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public async Task<ServiceResponse<GetProductSpecialDto>> GetProductSpecialForIdAsync(int Id)
        {
            ServiceResponse<GetProductSpecialDto> serviceResponse = new ServiceResponse<GetProductSpecialDto>();
            try
            {
                //Obtiene el producto.
                var product = await this._productSpecialRepositoryModel
                .GetProductSpecialForIdWithCategoryAsync(Id)
                .ConfigureAwait(false);
                if (product == null)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeProduct_NotFound;
        ...
        /// <returns></returns>
        public async Task<ServiceResponse<GetProductSpecialDto>> UpdateProductSpecialAsync(UpdateProductSpecialDto updateProductSpecial)
        {
            ServiceResponse<GetProductSpecialDto> serviceResponse = new ServiceResponse<GetProductSpecialDto>();
            try
            {
                if (updateProductSpecial == null)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeError_NullObjectSend;
                    serviceResponse.Data = null;
                    serviceResponse.Success = false;
                ...
                var product = await this._productSpecialRepositoryModel
                .GetProductSpecialForIdNotIncludeAsync(updateProductSpecial.ProductId)
                .ConfigureAwait(false);
                if (product == null)
                {
                    serviceResponse.Code = CodeMessage.Code.CodeProduct_NotFound;
                ...
                if (updateProductSpecial.IsAvailabe != null)
                product.IsAvailabe = (bool)updateProductSpecial.IsAvailabe;
                ...
                if (updateProductSpecial.Name != null)
                product.Name = updateProductSpecial.Name;
                if (updateProductSpecial.Price != null)
                product.Price = (decimal)updateProductSpecial.Price;
                if (updateProductSpecial.Stock != null)
                product.Stock = (int)updateProductSpecial.Stock;
                product.DateUpdate = DateTime.UtcNow;
                var update_product = await this._productSpecialRepositoryModel
                .UpdateProductSpecialAsync(product).
                ConfigureAwait(false);
